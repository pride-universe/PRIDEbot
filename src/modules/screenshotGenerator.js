...
const { puppeteerExecPath } = require('../../config');
...
class ScreenshotGenerator {
  ...
  async startBrowser() {
    ...
    const browser = this._browser = await puppeteer.launch({executablePath: puppeteerExecPath, args: ['--no-sandbox', '--disable-setuid-sandbox']});
