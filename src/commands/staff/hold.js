...
module.exports = class IdCommand extends RestrictedCommand {
  constructor(client) {
    super(client, {
      ...
      group: 'staff',
      memberName: 'hold',
      description: 'Prevents automatic upgrade of a new member (when no id is provided, it lists the currently held users)',
      examples: ['hold', 'hold add 141977677404962816', 'hold remove 141977677404962816'],
      clientPermissions: [],
      format: '[discord id]',
      permGroup: 'staff',
    });
